...
const Tags = () => {
    ...
    const tagsList = [{
        ...
        id:5,
        tagName: "PHP",
        tagDesc: "PHP is a widely used, open source, general-purpose, multi-paradigm, dynamically typed and interpreted scripting language orientally designed for server-side web development."
    },{
        id:6,
        tagName: "HTML",
        tagDesc: "HTML (or HyperText Markup Language) is the markup language used for creating web pages and other information to be displayed in a web browser. "
    },{
        id:7,
        tagName: "Android",
        tagDesc: "Android is Google's mobile operating system, used for programming or developing digital devices (Smartphones, Tablet, Automobiles, TVs, Wear, Glass, IoT)."
    },{
        id:8,
        tagName: "CSS",
        tagDesc: "CSS is a representation style sheet language used for describing the look and formatting of HTML, XML, documents and SVG elements including colors, fonts, layouts, and animations."
    },{
        id:9,
        tagName: "ReactJS",
        ...
        id:10,
        tagName: "NodeJS",
        tagDesc: "NodeJS is an event-based, non-blocking, asynchronous I/O runtime that uses Google's V8 JavaScript engine and libuv library."
    }]
